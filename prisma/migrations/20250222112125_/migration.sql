/*
  ...
  - You are about to drop the column `headline` on the `Comment` table. All the data in the column will be lost.
  - You are about to drop the column `src` on the `Comment` table. All the data in the column will be lost.
